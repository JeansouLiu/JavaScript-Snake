...
function getHighScore() {
    document.getElementById("high-score").addEventListener("click", function () {
        null == localStorage.jsSnakeHighScore ? alert("你还没有开始玩这个游戏!") : alert("您当前最高分为 " + localStorage.jsSnakeHighScore + ".")
    })
}
SNAKE.addEventListener = window.addEventListener ? function (e, t, n, a) {
    e.addEventListener(t, n, a)
}
 : window.attachEvent ? function (e, t, n) {
    e.attachEvent("on" + t, n)
}
 : void 0, SNAKE.removeEventListener = window.removeEventListener ? function (e, t, n, a) {
    e.removeEventListener(t, n, a)
}
 : window.detachEvent ? function (e, t, n) {
    e.detachEvent("on" + t, n)
}
 : void 0, SNAKE.Snake = SNAKE.Snake || function () {
    var f = [],
    v = function () {
        this.elm = null,
        this.elmStyle = null,
    ...
    return function (o) {
        if (o && o.playingBoard) {
            ...
            d.snakeHead.elm.className = d.snakeHead.elm.className.replace(/\bsnake-snakebody-dead\b/, ""),
            ...
            d.go = function () {
                ...
                n = s,
                a = l.grid;
                !0 !== m ? (d.snakeTail = t.prev, a[(d.snakeHead = t).row] && a[t.row][t.col] && (a[t.row][t.col] = 0), i.length && (n = s = i.pop()), t.col = e.col + r[n], t.row = e.row + c[n], t.xPos = e.xPos + u[n], t.yPos = e.yPos + h[n], t.elmStyle || (t.elmStyle = t.elm.style), t.elmStyle.left = t.xPos + "px", t.elmStyle.top = t.yPos + "px", 0 === a[t.row][t.col] ? (a[t.row][t.col] = 1, setTimeout(function () {
                            d.go()
                        }, k)) : 0 < a[t.row][t.col] ? d.handleDeath() : a[t.row][t.col] === l.getGridFoodValue() && (a[t.row][t.col] = 1, d.eatFood(), setTimeout(function () {
                            d.go()
            ...
            d.eatFood = function () {
                f.length <= 5 && y(10);
                for (var e, t = f.splice(0, 5), n = t.length, a = d.snakeTail; n--; )
                    e = "b" + d.snakeLength++, d.snakeBody[e] = t[n], d.snakeBody[e].prev = a, d.snakeBody[e].elm.className = d.snakeHead.elm.className.replace(/\bsnake-snakebody-dead\b/, ""), d.snakeBody[e].elm.className += " snake-snakebody-alive", a.next = d.snakeBody[e], a = d.snakeBody[e];
            ...
            d.handleDeath = function () {
                var e;
                null == (e = localStorage.jsSnakeHighScore) && localStorage.setItem("jsSnakeHighScore", d.snakeLength),
                d.snakeLength > e && (alert("恭喜! 你打破了你的最高纪录, " + e + "."), localStorage.setItem("jsSnakeHighScore", d.snakeLength)),
                d.snakeHead.elm.style.zIndex = function (e) {
                    var t,
                    n = 0,
                    a = 0;
                    for (t in e)
                        e[t].elm.currentStyle ? a = parseFloat(e[t].elm.style["z-index"], 10) : window.getComputedStyle && (a = parseFloat(document.defaultView.getComputedStyle(e[t].elm, null).getPropertyValue("z-index"), 10)), !isNaN(a) && n < a && (n = a);
                    return n + 1
                }
                (d.snakeBody),
                d.snakeHead.elm.className = d.snakeHead.elm.className.replace(/\bsnake-snakebody-alive\b/, ""),
            ...
            d.reset = function () {
                if (!1 !== p) {
                    for (var e, t = [], n = d.snakeHead.next; n !== d.snakeHead; )
                        e = n.next, n.prev = null, n.next = null, t.push(n), n = e;
                    d.snakeHead.next = d.snakeHead,
                    d.snakeHead.prev = d.snakeHead,
                    d.snakeTail = d.snakeHead,
                    d.snakeLength = 1;
                    for (var a = 0; a < t.length; a++)
                        t[a].elm.style.left = "-1000px", t[a].elm.style.top = "-1000px", t[a].elm.className = d.snakeHead.elm.className.replace(/\bsnake-snakebody-dead\b/, ""), t[a].elm.className += " snake-snakebody-alive";
                    f.concat(t),
                    d.snakeHead.elm.className = d.snakeHead.elm.className.replace(/\bsnake-snakebody-dead\b/, ""),
                    d.snakeHead.elm.className += " snake-snakebody-alive",
        ...
        function g() {
            ...
            return e.className = "snake-snakebody-block",
            e.style.left = "-1000px",
            e.style.top = "-1000px",
        ...
        function y(e) {
            for (var t, n = g(), a = 1; a < e; a++)
                (t = new v).elm = n.cloneNode(!0), t.elmStyle = t.elm.style, l.getBoardContainer().appendChild(t.elm), f[f.length] = t;
            (t = new v).elm = n,
    ...
    return function (e) {
        if (e && e.playingBoard) {
            ...
            this.randomlyPlaceFood = function () {
                i.grid[d] && i.grid[d][l] === i.getGridFoodValue() && (i.grid[d][l] = 0);
                for (var e = 0, t = 0, n = 0, a = i.grid.length - 1, o = i.grid[0].length - 1; 0 !== i.grid[e][t]; )
...
(), SNAKE.Board = SNAKE.Board || function () {
    ...
    return function (e) {
        ...
        d = !1;
        function S() {
            (v = document.createElement("div")).setAttribute("id", "playingField"),
            v.className = "snake-playing-field",
            SNAKE.addEventListener(v, "click", function () {
                f.focus()
            }, !1),
            (a = document.createElement("div")).className = "snake-pause-screen",
            a.innerHTML = "<div style='padding:10px;'>[暂停中]<p/>按 [空格] 继续.</div>",
            (w = document.createElement("div")).className = "snake-panel-component",
            w.innerHTML = "©<a href='https://blog.jeansou.com' class='snake-link'>Jeansou</a> - <a href='https://github.com/JeansouLiu/JavaScript-Snake' class='snake-link'>源码</a>",
            (B = document.createElement("div")).className = "snake-panel-component",
            B.innerHTML = "长度: 1",
            t = function () {
                var e = document.createElement("div");
                e.id = "sbWelcome" + l,
                e.className = "snake-welcome-dialog";
                var t = document.createElement("div"),
                n = "";
                E.fullScreen && (n = "按 F11 全屏.");
                t.innerHTML = "JavaScript 贪吃蛇<p></p>使用 <strong>↑ ↓ ← →</strong> 控制蛇的方向. " + n + "<p></p>";
                ...
                return SNAKE.addEventListener(window, "keyup", d, !1),
            ...
            n = function () {
                ...
                var e = document.createElement("div");
                e.innerHTML = "JavaScript 贪吃蛇<p></p>你失败了 :(<p></p>";
                var t = document.createElement("button");
                t.appendChild(document.createTextNode("再来一次?"));
                var a = function () {
                ...
                return SNAKE.addEventListener(window, "keyup", function (e) {
            ...
            (),
            SNAKE.addEventListener(f, "keyup", function (e) {
                if (!e)
                    e = window.event;
        ...
        b.setupPlayingField = function () {
            ...
            a;
            v || S(),
            !0 === E.fullScreen ? (cTop = 0, cLeft = 0, a = 0, "number" == typeof window.innerWidth ? a = window.innerWidth : document.documentElement && (document.documentElement.clientWidth || document.documentElement.clientHeight) ? a = document.documentElement.clientWidth : document.body && (document.body.clientWidth || document.body.clientHeight) && (a = document.body.clientWidth), e = a - 5, n = 0, "number" == typeof window.innerHeight ? n = window.innerHeight : document.documentElement && (document.documentElement.clientWidth || document.documentElement.clientHeight) ? n = document.documentElement.clientHeight : document.body && (document.body.clientWidth || document.body.clientHeight) && (n = document.body.clientHeight), t = n - 5, document.body.style.backgroundColor = "#FC5454") : (cTop = E.top, cLeft = E.left, e = E.width, t = E.height);
            ...
            b.grid = [];
            for (var c = d / b.getBlockWidth() + 2, u = i / b.getBlockHeight() + 2, h = 0; h < u; h++) {
                b.grid[h] = [];
                for (var k = 0; k < c; k++)
                    b.grid[h][k] = 0 === k || 0 === h || k === c - 1 || h === u - 1 ? 1 : 0
            }
            function p(e, t) {
                document.getElementById(e).addEventListener("click", function () {
                    snakeSpeed = t
            ...
            y = function (e) {
                ...
                if (1 === b.getBoardState()) {
                    if (!(37 <= t && t <= 40) && 87 !== t && 65 !== t && 83 !== t && 68 !== t)
                        return;
                    SNAKE.removeEventListener(f, "keydown", y, !1),
                    y = function (e) {
                        if (!e)
                            e = window.event;
                        var t = e.which ? e.which : e.keyCode;
                        return 32 === t && 0 != b.getBoardState() && b.setPaused(!b.getPaused()),
                        g.handleArrowKeys(t),
                        e.cancelBubble = !0,
                        e.stopPropagation && e.stopPropagation(),
                        e.preventDefault && e.preventDefault(),
        ...
        b.foodEaten = function () {
            B.innerHTML = "长度: " + g.snakeLength,
            m.randomlyPlaceFood()
        },
        b.handleDeath = function () {
            var e = Math.max(s(g.snakeBody), s({
                        tmp: {
                            elm: m.getFoodElement()
                        }
                    }));
            f.removeChild(n),
            f.appendChild(n),
        ...
        E.fullScreen && SNAKE.addEventListener(window, "resize", function () {
            b.setupPlayingField()
        }, !1),
        b.setBoardState(0),
